...
function SelectImage(fname,stype,imgsel)
{
	...
	if(!stype) stype = '';
	window.open("../includes/dialog/select_images.php?f="+fname+"&noeditor=yes&imgstick="+stype+imgsel, "popUpImagesWin", "scrollbars=yes,resizable=yes,statebar=no,width=650,height=400,left="+posLeft+", top="+posTop);
}
...
function SelectImageN(fname,stype,vname)
{
	...
	if(!fname) fname = 'form1.picname';
	if(!stype) stype = '';
	window.open("../includes/dialog/select_images.php?f="+fname+"&imgstick="+stype+"&v="+vname, "popUpImagesWin", "scrollbars=yes,resizable=yes,statebar=no,width=600,height=400,left="+posLeft+", top="+posTop);
}
