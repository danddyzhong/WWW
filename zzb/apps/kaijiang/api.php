...
function apiplus_curl($code,$row){
	...
	$ch = curl_init();
	$api=array();
	$api['bjpk10']="http://api.api68.com/pks/getLotteryPksInfo.do?lotCode=10001";
	$api['cqssc']="http://api.api68.com/CQShiCai/getBaseCQShiCai.do?lotCode=10002";
	$api['jsk3']="http://api.api68.com/lotteryJSFastThree/getBaseJSFastThree.do?lotCode=10007";
	$api['gdklsf']="http://api.api68.com/klsf/getLotteryInfo.do?lotCode=10005";
	$api['cqklsf']="http://api.api68.com/klsf/getLotteryInfo.do?lotCode=10009";
	$api['xjssc']="http://api.api68.com/CQShiCai/getBaseCQShiCai.do?lotCode=10004";
	$api['bjkl8']="http://api.api68.com/LuckTwenty/getBaseLuckTewnty.do?lotCode=10014";
	$api['hk6']="http://1680660.com/smallSix/findSmallSixInfo.do?lotCode=10048";
	$api['fc3d']="http://api.api68.com/QuanGuoCai/getLotteryInfo1.do?&lotCode=10041";
	$api['pl3']="http://api.api68.com/QuanGuoCai/getLotteryInfo1.do?&lotCode=10043";

	curl_setopt($ch, CURLOPT_URL, $api[$code]);
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
	curl_setopt($ch, CURLOPT_HEADER, 0);
	curl_setopt($ch, CURLOPT_REFERER, "http://kj.kai861.com/");
